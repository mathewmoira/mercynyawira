    ...
    <div className="relative">
      ...
      >
        <div className="fixed top-4 left-1/2 -translate-x-1/2 z-50 w-[95%] max-w-7xl mx-auto">
          <nav className={`
            w-full rounded-full transition-all duration-300 backdrop-blur-xl
            ${isHomePage ? 'bg-[#0000004d] border border-gold/10' : 'bg-[#0000004d] border border-gold/20'}
            ...
            <div className="px-6 py-3">
              ...
              <div 
                className={`
                  ...
                  bg-black/95 backdrop-blur-md border border-gold/10 
